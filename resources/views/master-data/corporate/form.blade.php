...
@component('component.form')
    @slot('action', !isset($data['detail']) ? route('user_corporate.save') : route('user_corporate.update'))
    @isset ($data['detail'])
        @slot('method','PUT')
    @else
        @slot('method','POST')
    ...
    <div class="form-group mb-3">
        ...
        <input type="hidden" value="{{ !isset($data['detail']) ? '' : $data['detail']->id }}" name="corporate_id">
