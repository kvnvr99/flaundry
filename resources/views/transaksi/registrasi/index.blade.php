                            ...
                            <div class="card-body">
                                <div class="row mb-3 p-1">
                                    ...
                                    <div class="col-6 text-right">
                                        <a href="{{ route('registrasi.history') }}" class="btn btn-primary">History</a>
                                    </div>
                                </div>
                                <div id="basicwizard">
                                                    ...
                                                    <div class="col-12">
                                                                ...
                                                                <div class="selectize-control multi">
                                                                    <div style="height: auto;"
                                                                        ...
                                                                        <input type="text" autocomplete="off"
                                                                            tabindex="" id="selectize-outlet-selectized"
                                                        ...
                                                        <div class="form-group row mb-3">
                                                            ...
                                                            <div class="col-md-9">
                                                                <div class="selectize-control multi">
                                                                    <div
                                                                        ...
                                                                        <div class="select-input item"
                                                                            data-value="super_express">SUPER EXPRESS</div>
                                                                        <input type="text" autocomplete="off"
                                                                            tabindex="" id="selectize-tags-selectized"
                                                                            style="width: 4px; opacity: 0; position: absolute; left: -10000px;">
                                                                    </div>
                                                                    <div class="selectize-dropdown multi"
                                                                        style="display: none;">
                                                                ...
                                                                <input type="text" name="kategori" id="selectize-tags"
                                                                    tabindex="-1" class="selectized"
                                                                    style="display: none;">
                                                            </div>
                                                        </div>
                                                        <div class="form-group row mb-3">
                                                            ...
                                                            <div class="col-md-9">
                                                                ...
                                                                <input type="text" id="selectize-pelanggan"
                                                                    name="pelanggan" tabindex="-1" class="selectized"
                                                                    style="display: none;">
                                                            </div>
                                                        </div>
                                                        <div class="form-group row mb-3 pilih_member"
                                                            ...
                                                            <label class="col-md-3 col-form-label" for="show-member">Pilih
                                                                Member</label>
                                                            <div class="col-md-4">
                                                                <button type="button" id="show-member"
                                                                    class="btn btn-secondary" data-toggle="modal"
                                                                    data-target="#modal-member"><i
                                                        ...
                                                        <div class="form-group row mb-3">
                                                            ...
                                                            <div class="col-md-9">
                                                                ...
                                                                <input type="text" name="parfume"
                                                                    id="selectize-parfume" tabindex="-1"
                                                            ...
                                                            <table
                                                                ...
                                                                <thead>
                                                                    <tr>
                                                                        ...
                                                                        <th class="text-center">Quantity Special Treatment
                                                                        </th>
                                                        ...
                                                        <div class="form-group row mb-3">
                                                            ...
                                                            <div class="col-md-9">
                                                                ...
                                                                <input type="text" name="pembayaran"
                                                                    id="selectize-pembayaran" tabindex="-1"
                                                                    class="selectized" style="display: none;">
                                                            </div>
                                                        </div>
                                                        <div class="form-group row mb-3">
                                                            <label class="col-md-3 col-form-label"
                                                                for="bayar">Bayar</label>
                                                            <div class="col-md-9">
                                                                <input readonly type="text"
                                                                    class="form-control first-outlet" id="bayar"
                                                                    name="bayar" autocomplete="off"
