                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" id="deliver_by" name="deliver_by">
...
<script>
    function open_modal(id){
        $.ajax({
            type:"POST",
            url: "{!! route('expedisi-jadwal-antar.get-data-info') !!}",
            data: { id: id },
            dataType: 'json',
    ...
    $('#modalForm').submit(function(e) {
        ...
        $.ajax({
            type:'POST',
            url: "{!! route('expedisi-jadwal-antar.store') !!}",
            data: formData,
            cache:false,
            contentType: false,
            processData: false,
