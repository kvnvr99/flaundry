...
<html lang="en">
    <head>
        ...
        <meta charset="utf-8" />
        <title>Corporate | FruitsLaundry</title>
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <meta content="Corporate FruitsLaundry" name="description" />
                        ...
                        <ul id="side-menu">
                            ...
                            <li>
                                ...
                                <div class="collapse" id="sidebarContacts">
                                    <ul class="nav-second-level">
                                        <li>
                                            <a href="contacts-list.html">Corporates List</a>
                                        </li>
                                        <li>
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <p class="mb-0 text-muted"><small>Corporate Since 2017</small></p>
                                                    </td>
